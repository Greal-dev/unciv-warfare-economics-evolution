...
class GameInfo : IsPartOfGameInfoSerialization, HasGameInfoSerializationVersion {
    ...
    var customAiGrowthModifier = 1f
    var customAiGoldModifier = 1f
    var customAiScienceModifier = 1f
    ...
    fun clone(): GameInfo {
        ...
        toReturn.customAiProductionModifier = customAiProductionModifier
        toReturn.customAiGrowthModifier = customAiGrowthModifier
        toReturn.customAiGoldModifier = customAiGoldModifier
