...
class MajorCivDiplomacyTable(private val diplomacyScreen: DiplomacyScreen) {
    ...
    private fun getNegotiatePeaceMajorCivButton(
        ...
        // Territorial Warfare: civs with no cities accept peace immediately
        if (otherCiv.cities.isEmpty()) {
            negotiatePeaceButton.onClick {
                ...
                tradeLogic.currentTrade.theirOffers.add(peaceTreaty)
                tradeLogic.currentTrade.ourOffers.add(peaceTreaty)
