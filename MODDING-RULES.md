...
### 1.6 — Territory Exchange with City-States

A diplomacy interface allows tile exchange with allied city-states:
- **Demand a tile:** costs 50 influence per tile
...
### 1.6 — Echange de territoire avec les cites-etats

Une interface diplomatique permet l'echange de tuiles avec les cites-etats alliees :
- **Exiger une tuile :** coute 50 d'influence par tuile
